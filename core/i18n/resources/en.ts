...
export const en = {
  ...
  sidepanel: {
    ...
    projectsPage: {
      title: 'Projects',
      description: 'Attach local files or GitHub repositories as prompt context. Relevant chunks are selected per prompt.',
      summary: '{projects} projects, {files} files',
      createTitle: 'Create project',
      namePlaceholder: 'Project name',
      instructionsPlaceholder: 'Project instructions',
      createProject: 'Create project',
      empty: 'No project context',
      emptyHelp: 'Create a project, then import a repository, folder, or manual note. Enabled content is selected into prompts when relevant.',
      deleteProject: 'Delete',
      deleteConfirm: 'Delete project "{name}"?',
      activateProject: 'Activate {name}',
      fileCount: '{count} files',
      activeProject: 'Active project: {name}',
      githubPlaceholder: 'https://github.com/owner/repo',
      githubTokenPlaceholder: 'GitHub token (optional, not saved)',
      githubTokenHelp: 'For private repositories or 403/rate-limit errors, enter a fine-grained token. Read-only repository access is enough. DeepSeek++ does not save or sync it.',
      importGithub: 'Import GitHub repo',
      importingGithub: 'Importing...',
      permissionError: 'GitHub API and raw content permissions are required to import project context',
      importComplete: 'Imported {count} files.',
      importCompleteWithWarnings: 'Imported {count} files, {warnings} warnings.',
      manualPathPlaceholder: 'Manual file path',
      manualContentPlaceholder: 'Manual file content',
      addManualFile: 'Add manual file',
    ...
    whatsNew: {
      ...
      interactiveTools: 'Sandbox approvals, Skill drafts, memory import, voice, saved snippets, and prompt controls are ready.',
      productSurfaces: 'Saved-item export, history organization, code downloads, and developer playground surfaces are available.',
    },
    memoryPage: {
      title: 'Memory',
    ...
    settings: {
      ...
      syncCounts: '{memories} memories, {skills} Skills, {presets} presets, {projects} projects, {projectFiles} project files, {savedItems} saved items',
    ...
    developerSettings: {
      ...
      developerModeDescription: 'Show advanced local tools for testing DeepSeek++ behavior',
      apiPlayground: 'API playground',
      apiPlaygroundDescription: 'Enable manual official API test calls with the locally stored API Key',
      cssPolicy: 'Arbitrary custom CSS remains disabled. Only bounded first-party theme controls are allowed.',
    },
    developerPage: {
      title: 'API playground',
      description: 'Run a single manual DeepSeek API call for local testing. API Keys are never shown, synced, or exported.',
      disabled: 'Developer mode is disabled. Enable it in Settings to show local testing tools.',
      playgroundDisabled: 'API playground is disabled in Developer options.',
      promptPlaceholder: 'Prompt for a one-off API test',
      run: 'Run API call',
      running: 'Running...',
      runFailed: 'API playground run failed',
    },
    voice: {
      title: 'Voice',
      input: 'Voice input',
  ...
  tool: {
    ...
    artifact: {
      ...
      createDescription: 'Create a downloadable file for the user. Use this for generated scripts, markdown, HTML, JSON, or other text artifacts.',
    ...
    sandbox: {
      runTitle: 'Request sandbox run',
      runDescription: 'Prepare JavaScript, TypeScript, or Python code for user-approved execution. The code is never executed until the user reviews and clicks Run.',
      languageDescription: 'Runtime language: javascript, typescript, or python',
      codeDescription: 'Code to run after user approval',
      ...
      approvalDetail: 'The code is ready, but will not run until the user approves it.',
      invalidRequest: 'Invalid sandbox request',
      unsupportedApprovedLanguage: 'Unsupported approved sandbox language',
      pythonUnavailable: 'Python sandbox unavailable',
      pythonUnavailableDetail: 'Enable python_exec through Shell Native Host before approving Python sandbox runs.',
    },
    skillCreator: {
      title: 'Draft a Skill',
